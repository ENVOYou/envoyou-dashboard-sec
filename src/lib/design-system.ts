/**
 * Modern Corporate SaaS Design System
 * Inspired by GitHub, Vercel, and Linear design patterns
 */

export const designTokens = {
  // Colors - Corporate SaaS palette
  colors: {
...
export const patterns = {
  ...
  interactive: 'hover:bg-gray-50 cursor-pointer transition-colors duration-150',
